...
int main(void) {
        ...
        switch (func) {
            case 1 : //로그인
                ...
                if (CheckUser(a)) { //회원가입 되어있는 유저인지 확인
                    ...
                    MakeLog(fp, GetISOTime(), userIdx, "signin");
                    break;
                }
                else { //회원가입 안되어 있을 때
            ...
            case 2 : //회원가입
                ...
                if (sign) {
                    ...
                    MakeLog(fp, GetISOTime(), idx, "signup");
                    continue;
                } else {
                    printf("error");
                    continue;
    ...
    while(isRoof) {
        ...
        if (function == 0) {  //종료
            printf("Bye.");
            MakeLog(fp, GetISOTime(), userIdx, "signout");
            break;
        }
        switch (function) {
            case 1 : { // 계획 추가
                ...
                MakeLog(fp, GetISOTime(), userIdx, "add plan success");
                break; }
            ...
            case 2 : { //계획 삭제
                ...
                if (!planLen) { //계획이 존재하지 않을 때
                    ...
                    MakeLog(fp, GetISOTime(), userIdx, "delete plan fail ( no exist plan )");
                    break;
                } //이전화면으로 돌아감
                ...
                while (1) { //계획 삭제
                    ...
                    if (num == 0) { //함수 끝내기
                        ...
                        MakeLog(fp, GetISOTime(), userIdx, "delete plan cancel");
                        break;
                    }
                    ...
                    MakeLog(fp, GetISOTime(), userIdx, "delete plan success");
                    break;
                }
                break; }
            ...
            case 3 : { // 계획 수정
                ...
                if (!planLen) { //계획이 존재하지 않을 때
                    printf("Plan does not exist. Return to the number selection window.\n\n");
                    MakeLog(fp, GetISOTime(), userIdx, "modify plan fail ( no exist plan )");
                    break;
                }
                ...
                while (1) { //수정할 게획 선택
                    ...
                    if (num == 0) { //함수 끝내기
                        ...
                        MakeLog(fp, GetISOTime(), userIdx, "modify plan cancel");
                        break;
                    }
                    ...
                    MakeLog(fp, GetISOTime(), userIdx, "modify plan success");
                    break;
                }
                break; }
            ...
            case 4 : { //계획 확인 
                ...
                if (!planLen) { //계획이 존재하지 않을 때
                    printf("Plan does not exist. Return to the number selection window.\n\n");
                    MakeLog(fp, GetISOTime(), userIdx, "check plan fail ( no exist plan )");
                    break;
                }
                ...
                MakeLog(fp, GetISOTime(), userIdx, "check plan success");
                break; }
            ...
            case 5 : { // 리뷰 확인
                ...
                if (!planLen) { //계획이 하나도 존재하지 않을 때
                    printf("Plan does not exist. Return to the number selection window.\n\n");
                    MakeLog(fp, GetISOTime(), userIdx, "check reiew fail ( no exist plan )");
                    break;
                }
                ...
                MakeLog(fp, GetISOTime(), userIdx, "check review success");
                break; }
            ...
            case 6 : { // 친구 계획 확인
                ...
                if (!friendLen) { //친구가 하나도 존재하지 않을 때
                    ...
                    MakeLog(fp, GetISOTime(), userIdx, "check friend plan fail ( no exist friend )");
                    break;
                }
                ...
                if (number > friendLen || number < 0) { //idx를 벗어난 수 선택시
                    ...
                    MakeLog(fp, GetISOTime(), userIdx, "check friend plan fail ( no exist friendIdx )");
                    break;
                }
                --number;
                ...
                if (!planLen) { //친구의 계획이 존재하지 않을 때
                    ...
                    MakeLog(fp, GetISOTime(), userIdx, "check friend plan fail ( no exist friend planIdx )");
                    break;
                }
                free(idxArr);
                ...
                if (number > planLen || number < 0) { //선택한 번호에 계획이 존재하지 않을 때
                    printf("Number does not exist. Return to the number selection window.\n\n");
                    MakeLog(fp, GetISOTime(), userIdx, "check friend plan fail ( wrong number )");
                    break;
                }
                --number;
                ...
                free(idxArr2);
                MakeLog(fp, GetISOTime(), userIdx, "check friend plan success ");
                break; }
            ...
            case 8 : { // 챌린지 만들기
                ...
                MakeLog(fp, GetISOTime(), userIdx, "make challenge success");
                break; }
            ...
            case 9 : { // 챌린지 참여
                ...
                if (!userLen) { //유저 존재하지 않을시
                    ...
                    MakeLog(fp, GetISOTime(), userIdx, "join challenge fail ( no exist depositIdx )");
                    break;
                }
                ...
                if (check) { //check = 1 일 때, 이미 참여중인 챌린지 입니다. print후 끝내기
                    ...
                    MakeLog(fp, GetISOTime(), userIdx, "join challenge fail ( already joined )");
                    break;
                }
                printf("--------------------------------------\n");
                ...
                MakeLog(fp, GetISOTime(), userIdx, "join challenge success");
                break; }
            ...
            case 10 : { // 챌린지 확인
                ...
                for (int i = 0; i < len; ++i) { //모든 챌린지와 챌린지 참여중인 유저 수 print
                    ...
                    printf("--------------------------------------\n");
                    MakeLog(fp, GetISOTime(), userIdx, "check challenge success");
                }
                break; }
